...
> 📖 **完整参数列表**：详细参数说明请参考 [CLI 命令 - zcf init](https://zcf.ufomiao.com/zh-CN/cli/init) 章节。
...
1. 🎯 探索 [功能特性](https://zcf.ufomiao.com/zh-CN/features/) 了解 ZCF 的完整能力
2. 📚 深入学习 [工作流详解](https://zcf.ufomiao.com/zh-CN/workflows/) 掌握各种工作流
3. ⚙️ 参考 [配置管理](https://zcf.ufomiao.com/zh-CN/advanced/configuration) 进行个性化设置
4. 🔧 查看 [CLI 命令](https://zcf.ufomiao.com/zh-CN/cli/) 掌握所有可用命令